...
<body>
		...
		<div class="header-w3l">
			<h1 style="font-size: 25px; margin-bottom: 50px;"> HỆ THỐNG ĐÁNH GIÁ CHỈ SỐ CẢI CÁCH HÀNH CHÍNH CÔNG </h1>
		</div>
		<!--//header-->
		<!--main-->
		<div class="main-w3layouts-agileinfo">
	           <!--form-stars-here-->
						<div class="wthree-form">
							...
							@endif
							<form action="{{route('loginUserpost')}}" method="post">
		...
		<!--footer-->
		<div class="footer">
			<p>&copy; 2019 Phần mềm quản trị hành chính công | Design by Nguyen Xuan Son <a>W3layouts</a></p>
		</div>
		<!--//footer-->
</body>
</html>