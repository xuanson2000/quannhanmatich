...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
  ...
  <h4 style="margin-bottom: 20px; margin-top: 20px;">DANH SÁCH SẢN PHẨM - DỊCH VỤ</h4>            
  <table class="table table-bordered">
    ...
    <tbody>
     ...
     @foreach($sanphams as $sanpham)
        ...
        <td><img style="width:120px; height: 120px;" src="public/anh/{{$sanpham->anh}}"></td>
        <td> <a href="{{route('suasanpham',[$sanpham->id])}}"> <img  alt="Sửa" src="public/anh/b_edit.png"></a> 

         <a onclick="return xacnhanxoa('Bạn có chắc chắn muốn xóa không')"  href="{{route('xoasanpham',[$sanpham->id])}}"><img alt="Xóa" src="public/anh/b_drop.png"></td></a> 	
      </tr>
      @endforeach
    </tbody>
  </table>
