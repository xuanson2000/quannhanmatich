...
<form action="{{route('themquannhanpost')}}" method="POST" enctype="multipart/form-data">
            <input type="hidden"  name="_token" value="{{csrf_token()}}" >
            
            <div class="row">
             <div class="col-md-4">
              <p style="color: blue; font-weight: bold; font-size: 16px; border-bottom: 2px solid blue; margin-bottom: 20px;">Thêm dữ liệu Quân nhân mất tin, mất tích</p>
             ...
             <div class="form-group">
               ...
               <input type="date" class="form-control" name="ngaynhapngu"  >
             </div>
             <div class="form-group">
          ...
          <div class="col-md-4" style="margin-top: 40px;">
             ...
             <div class="form-group">
               ...
               <input type="text" class="form-control" name="hotenbo"  >
             </div>

             <div class="form-group">
               <label for="usr">Họ tên Mẹ  </label>
               <input type="text" class="form-control" name="hoteme "  >
             </div>
              <div class="form-group">
               <label for="usr">Họ tên Vợ  </label>
               <input type="text" class="form-control" name="hotenvo"  >
             </div>
             <div class="form-group">
             	<label for="usr">Người thân khác  </label>
             	<input type="text" class="form-control" name="nguoithankhac"  >
             </div>
               <div class="form-group">
    	...
    	<div class="form-group">
    		...
    		<textarea type="text" class="form-control" name="hosoluuluu" >
              ...
              <div class="form-group">
              	...
              	<label><input type="radio" name="radio1" value="Đã tổ chức xác minh" onClick="getResults()"> Đã tổ chức xác minh </label><br>

              	<label><input type="radio" name="radio1" value="Chưa tổ chức xác minh">  Chưa  tổ chức xác minh </label>
             ...
             <div class="form-group">
             	...
             	<input type="date" class="form-control" name="ngaybaotu">
             </div>	

             <div class="form-group">
             	<label for="usr">Số giấy báo tử </label>
             	<input type="text" class="form-control" name="sogiaybaotu">
             </div>	</div>
