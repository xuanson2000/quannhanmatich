...
<div class="container" style="background-color: white; padding: 20px 20px 20px 30px; width: 100%;">
  ...
  <h4 style="margin-bottom: 20px; margin-top: 20px;">DANH SÁCH SLIDE</h4>            
    ...
    <tbody>
     ...
     @foreach($slides as $slide)
        ...
        <td>{{$loop->index+1}}</td>
           ...
           <td><img style="width:300px; height:100;" src="public/anh/{{$slide->anh}}"></td>
          <td>{{$slide ->noiDung}}</td>
       
        
        <td> <a href=""> <img  alt="Sửa" src="public/anh/b_edit.png"></a> 

         <a onclick="return xacnhanxoa('Bạn có chắc chắn muốn xóa không')"  href="{{route('xoaslide',[$slide->id])}}"><img alt="Xóa" src="public/anh/b_drop.png"></a></td> 	
      </tr>
      @endforeach
    </tbody>
  </table>
